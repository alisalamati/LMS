...
from course.views import vw_course_list, vw_course_register, vw_department_list, vw_department_info, vw_course_dept_list
...
urlpatterns = [
    ...
    re_path('^department-list/(\d+)/(\w+)/$',vw_course_dept_list),
